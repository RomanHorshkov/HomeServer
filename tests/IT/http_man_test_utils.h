 ...
 *
 * The function fills the request with a minimal set of headers followed by
 * synthetic `X-FILL-XX` headers until the buffer reaches exactly the requested
 * size. Returns NULL if the requested size cannot be reached.
 *
