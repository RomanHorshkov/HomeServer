...
#    define HTTP_ERRNO_MAP(XX)                                       \
        ...
        XX(34, CB_CHUNK_EXTENSION_NAME_COMPLETE,                     \
           CB_CHUNK_EXTENSION_NAME_COMPLETE)                         \
        XX(35, CB_CHUNK_EXTENSION_VALUE_COMPLETE,                    \
...
#    define HTTP_STATUS_MAP(XX)                                               \
        ...
        XX(299, MISCELLANEOUS_PERSISTENT_WARNING,                             \
        ...
        XX(497, HTTP_REQUEST_SENT_TO_HTTPS_PORT,                              \
