...
/* Home page URI */
#define ROUTER_HOME_PAGE "index.html"

/* Map json file (AUTOGENERATED) */
#define ROUTER_MAP_JSON "map.json"

/* Routes json file (DO NOT REMOVE, SYNC WITH FRONTEND)*/
#define ROUTER_ROUTES_JSON "routes.json"
